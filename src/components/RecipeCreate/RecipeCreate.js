...
function RecipeCreate() {
	...
	function submitRecipeHandler(e) {
		e.preventDefault();
		if (errorValidationHandler()) {
			addRecipeDetailsHandler(e);
			recipeService
				.createRecipe(recipe, user.accessToken)
				.then((result) => {
			...
			<div id="recipe-post" className="container-sm text-dark bg-light bg-opacity-25 wow fadeIn">
				<div className="row d-flex justify-content-center">
					<div className="col-lg-8">
						...
						<div className="row d-flex justify-content-center">
							<form id="createRecipeForm" onSubmit={submitRecipeHandler}>
								<div className="single-post__leave__comment">
									<div className="widget__title text-center">
										<h4>Step 1: Add basic information for your recipe!</h4>
									</div>
								...
								<button type="submit" onClick={(e) => submitRecipeHandler(e)} className="w-100 site-btn btn btn-primary">
									Submit
								</button>
							</form>
						</div>
